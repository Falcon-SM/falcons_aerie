      ...
      <header className="relative bg-slate-800/40 border-b border-slate-700">
        <div className="container mx-auto px-4 py-12 text-center">
          ...
          <p className="text-base md:text-lg text-slate-300 max-w-2xl mx-auto leading-relaxed">
            ...
            どうぞよろしくお願いします。<br />
            <br />
            X → <a href="https://x.com/leopard_shun?s=21" className="text-blue-400 hover:text-blue-300 transition-colors duration-200" target="_blank" rel="noopener noreferrer">@Leopard_shun</a>
          </p>
        </div>
      </header>
      <div className="container mx-auto px-4 py-12 text-center">
